...
CREATE POLICY IF NOT EXISTS "Officials can view their buses"
ON public.buses
FOR SELECT
...
-- Allow officials to update route frequencies (in addition to existing admins/managers policy)
CREATE POLICY IF NOT EXISTS "Officials can update route frequencies"
...
-- Admins/managers can create notifications (optional app-side usage)
CREATE POLICY IF NOT EXISTS "Admins/managers can create notifications"
ON public.notifications
FOR INSERT
